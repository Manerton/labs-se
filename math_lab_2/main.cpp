...
int main()
{
    ...
    while (ch == 1)
    {
        ...
        cout << "б) антирефлексивность - "; // в главной диагонали только нули
        ...
        cout << "е) асимметричность - " << ex7_e(E) << endl; // главная диагональ нулевая и симметричных элементов относительно диагонали нет
