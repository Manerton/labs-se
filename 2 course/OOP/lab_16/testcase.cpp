...
TEST_CASE("Тест класса Queue1 (композиция)")
{
    SUBCASE("Тест создания и присваивания") // -- создание и присваивание --
    {
        Queue1<UnemployedElem> w;
        CHECK(w.size() == 0);
        CHECK(w.empty());
        Queue1<UnemployedElem> e;
        UnemployedElem a("1314",44,1,{4,4},{7,3},45500);
        UnemployedElem b("5231",33,1,{5,0},{11,4},154355);
        UnemployedElem c{"33",25,0,{1,2},{3,7},18543};
        e.push(a);
        ...
        CHECK(e.front() == a);
        CHECK(e.size() == 3);
        Queue1<UnemployedElem> r(e);
        CHECK((r == e));
        Queue1<UnemployedElem> t = e;
        CHECK((t == e));
    ...
    SUBCASE("Тест создания и присваивания для int") // -- создание и присваивание --
    {
        Queue1<int> w;
        CHECK(w.size() == 0);
        CHECK(w.empty());
...
TEST_CASE("Тест класса Queue2 (наследование)")
{
    SUBCASE("Тест создания и присваивания") // -- создание и присваивание --
    {
        Queue2<UnemployedElem> w;
        CHECK(w.size() == 0);
        CHECK(w.empty());
        Queue2<UnemployedElem> e;
        UnemployedElem a("1314",44,1,{4,4},{7,3},45500);
        UnemployedElem b("5231",33,1,{5,0},{11,4},154355);
        UnemployedElem c{"33",25,0,{1,2},{3,7},18543};
        e.push(a);
        ...
        CHECK(e.front() == a);
        CHECK(e.size() == 3);
        Queue2<UnemployedElem> r(e);
        CHECK((r == e));
        Queue2<UnemployedElem> t = e;
        CHECK((t == e));
