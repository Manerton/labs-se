...
int main()
{
    ...
    try // ищем исключения, которые выбрасываются в блоке try и отправляем их для обработки в блок(и) catch
    {
        ...
        Modulo BS3 = BS2;
        cout << "BS3: " << BS3;
        Modulo testBS1("110101");
        Modulo testBS2("001001");
        Modulo testBS3("100110");
        Modulo testBS4("11010111100011101011110001011010110001100010000000000000000000011010111100011101011110001011010110001100010000000000000000000011");
    ...
    catch (Modulo::not_binary_exception)
    {
        cerr << "Ошибка: введенное число не является двоичным." << endl;
    }
    catch (Modulo::overflow_exception)
    {
