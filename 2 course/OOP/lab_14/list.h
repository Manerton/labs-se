...
public:
    // Конструкторы
    explicit const_iterator(List::Node* t) noexcept;
    ...
    List::const_reference operator*();               // разыменование
    bool isNullptr() const noexcept;
...
public:
    // Конструкторы
    explicit const_reverse_iterator(List::Node* t) noexcept;
    const_reverse_iterator() = default;
    bool operator==(const const_reverse_iterator &it) const noexcept;
    bool operator!=(const const_reverse_iterator &it) const noexcept;
    // Перемещение итератора
