...
class CPU
{
    ...
    cmd cmd; // -- текущая выполняемая длинная команда или две коротких -- //
     ...
     // -- предварительное объявление класса Command, чтобы избежать циклических зависимостей -- //
    class Command* command[128] = {nullptr};    // -- массив из 128 указателей на команды -- //
    friend class Command;   // -- дружественная класс команд (для доступа к was_transition) -- //
