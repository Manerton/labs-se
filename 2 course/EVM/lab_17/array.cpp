...
Array::Array(size_type n, value_type t)
{
    CheckZeroSize(n);
    size_array = n;
    data = (value_type*)GlobalAlloc(GMEM_FIXED, size_array * sizeof(value_type));
...
Array::Array(const Array &other) : size_array(other.size_array), data((value_type*)GlobalAlloc(GMEM_FIXED, size_array * sizeof(value_type)))
{
